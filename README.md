...
* Installation:
        ...
        pip install "biobb_structure_utils>=3.7.1"
...
* Installation:
        ...
        conda install -c bioconda "biobb_structure_utils>=3.7.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_structure_utils:3.7.1--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_structure_utils:3.7.1--pyhdfd78af_0 <command>
