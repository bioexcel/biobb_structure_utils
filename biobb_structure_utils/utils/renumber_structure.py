...
def main():
    ...
    RenumberStructure(input_structure_path=args.input_structure_path, output_structure_path=args.output_structure_path, output_mapping_json_path=args.output_mapping_json_path, properties=properties).launch()
